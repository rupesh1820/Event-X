    ...
    <main className="min-h-screen bg-[#080711] text-white">
      <section className="mx-auto grid max-w-7xl items-center gap-10 px-4 pb-8 pt-8 sm:px-6 lg:grid-cols-2 lg:px-10 lg:pt-12">
        <div>
          ...
          <h1 className="mt-4 max-w-lg text-4xl font-bold leading-tight sm:text-5xl">
            We&apos;d Love to{" "}
            <span className="text-violet-500">Hear From You!</span>
          </h1>
        ...
        <div className="flex h-56 items-center justify-center">
          <div className="relative flex h-36 w-48 items-center justify-center rounded-[45%] bg-violet-700 text-4xl shadow-2xl shadow-violet-900/60 after:absolute after:-bottom-7 after:right-5 after:border-[24px] after:border-transparent after:border-t-violet-700 after:rotate-[-20deg]">
            •••
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto grid max-w-7xl gap-5 px-4 pb-10 sm:px-6 lg:grid-cols-[1.1fr_.9fr] lg:px-10">
        <form
          ...
          className="rounded-xl border border-white/10 bg-[#0d0e18] p-5 sm:p-7"
        >
          <h2 className="text-xl font-semibold">Get in Touch</h2>
          <p className="mt-2 text-xs text-gray-400">
            Fill out the form and our team will respond to you shortly.
          </p>
          <div className="mt-5 grid gap-4 sm:grid-cols-2">
            <label className="text-xs text-gray-300">
              ...
              <input
                ...
                className="mt-2 w-full rounded-lg border border-white/10 bg-transparent px-3 py-3 text-sm text-white outline-none focus:border-violet-500"
              />
            </label>
            <label className="text-xs text-gray-300">
              Email Address
          ...
          <label className="mt-4 block text-xs text-gray-300">
            ...
            <select
              name="subject"
              className="mt-2 w-full rounded-lg border border-white/10 bg-[#12111d] px-3 py-3 text-sm text-white outline-none"
            >
          ...
          <label className="mt-4 block text-xs text-gray-300">
            ...
            <textarea
              ...
              className="mt-2 w-full resize-none rounded-lg border border-white/10 bg-transparent px-3 py-3 text-sm text-white outline-none focus:border-violet-500"
            />
          </label>
          <button
            type="submit"
          ...
          <div className="mt-5 grid gap-3">
            {[
              ...
              [
                ...
                "Visit Us",
                "EventX Headquarters",
                "123 Event Street, Andheri West, Mumbai, Maharashtra - 400059",
              ],
              [
                "◷",
                "Support Hours",
              ...
              <div
                key={title}
                className="flex gap-4 rounded-lg border border-white/10 bg-[#12111d] p-4"
              >
                <span className="text-xl text-violet-400">{icon}</span>
                <div>
                  <h3 className="text-sm font-semibold">{title}</h3>
                  <p className="mt-1 text-xs text-gray-300">{value}</p>
