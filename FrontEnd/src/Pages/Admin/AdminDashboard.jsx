...
const API_URL = import.meta.env.VITE_SERVER || "https://eventx-backend-pq2m.onrehttp://localhost:5001nder.com/https://eventx-backend-pq2m.onrender.com/https://eventx-backend-pq2m.onrehttp://localhost:5001nder.com/https://eventx-backend-pq2m.onrender.com";
const authConfig = () => ({
  headers: {
