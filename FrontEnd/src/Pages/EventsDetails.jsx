...
const EventsDetails = () => {
  ...
  const dateText = `${event.day} ${event.month} ${event.year}`;
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 text-white sm:px-6 lg:py-12 lg:px-8">
      <div className="mb-6 flex items-center gap-2 text-sm text-gray-300">
        ...
        <span>/</span>
        <span className="text-violet-400">{event.name}</span>
      </div>
        ...
        <div className="grid gap-0 lg:grid-cols-[1.2fr_0.8fr]">
          ...
          <div className="p-6 sm:p-8">
            <div className="flex items-center justify-between gap-3">
              ...
              <span className="text-sm text-gray-400">{event.availableTickets} tickets left</span>
            </div>

            <h1 className="mt-5 text-3xl font-bold leading-tight sm:text-4xl">{event.name}</h1>
            ...
            <div className="mt-8 rounded-2xl border border-white/10 bg-white/2 p-4">
              <div className="flex items-end justify-between gap-3">
                <div>
                  ...
                  <p className="text-3xl font-bold text-violet-400">₹{event.price}</p>
                </div>
      ...
      <div className="mt-10 grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
        <section className="rounded-2xl border border-white/10 bg-[#0d0e18] p-6">
          ...
          <p className="mt-4 text-base leading-7 text-gray-300">
            Join {event.name} for a curated experience designed to bring people together around creativity,
        ...
        <aside className="rounded-2xl border border-white/10 bg-[#0d0e18] p-6">
          ...
          <div className="mt-5 space-y-4 text-sm text-gray-300">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="font-semibold text-emerald-400">{event.availableTickets > 0 ? 'Open' : 'Sold out'}</span>
            </div>
          </div>
