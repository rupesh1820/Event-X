...
const Login = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      // Currently redirect everyone to home
      const destination = "/";

      /*
      // Agar future me role based redirect chahiye:
      ...
      <main className="mx-auto grid min-h-[calc(100vh-81px)] max-w-6xl items-center gap-12 px-5 py-12 sm:px-10 lg:grid-cols-2 lg:gap-20">
        ...
        <section className="hidden lg:block">
          ...
          <div className="relative overflow-hidden rounded-3xl border border-violet-500/20 bg-gradient-to-br from-violet-950 via-[#17112b] to-[#0d0b18] p-10">
            ...
            <p className="relative mt-5 max-w-md leading-7 text-gray-300">
              Join a community of event lovers
              and discover moments worth
              remembering.
            </p>
        ...
        <section className="mx-auto w-full max-w-md">
          ...
          <p className="mt-3 text-gray-400">
            Continue discovering experiences
            made for you.
          </p>
          ...
          >
            ...
            <div>
              ...
              <input
                ...
                placeholder="you@example.com or admin1820"
                value={emailAddress}
                onChange={(event) =>
                  setEmailAddress(
                    event.target.value
